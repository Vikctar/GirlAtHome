...
public class BookingsDB extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "bookingsTable";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_WISHLIST_TABLE = "CREATE TABLE " + TABLE_NAME + "("
                ...
                + COLUMN_STYLE_ID + " INTEGER UNIQUE," + COLUMN_STYLIST_ID + " TEXT,"
    ...
    public ArrayList<BookingModel> getAllBookings() {
        ...
        Cursor res = db.rawQuery("select * from bookingsTable", null);
        res.moveToFirst();
